# Added
- Used Bootstrap's Navbar
    - Name / Logo
    - Nav Links
- Used Bootstrap's Grid System
    - Establish Layout
    - Fake Story About Me
- Used Bootstrap's Cards Component
    - Hobbies
    - Interests
    - Career Goals
- Used Bootstrap's Slideshow Component
    - Picsum Random Images
- Used Bootstrap's Spacing Utility
    - Contains the Cards Above
- Used Bootstrap's Accordion Component
    - Ask / Answer Questions Based on Fake Story

![Lighthouse SEO Report](Lighthouse-SEO.jpg)
